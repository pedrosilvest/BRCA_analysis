...
sbatch_path=/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/scripts/newref_caveman
mkdir -p $sbatch_path

for i in "${!normal_bam[@]}"; do


    reference_index="/mnt/nfs/lobo/MCFONSECA-NFS/pedro.silvestre/BRCA_project/reference/C204${i}neg_reference.fa.fai"
    ignore_regions="/mnt/nfs/lobo/MCFONSECA-NFS/pedro.silvestre/ignore_regions.tsv"
    >"$ignore_regions"

    temp_path="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman"
    log_path=/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/output/logs/newref_caveman/C204${i}
    mkdir -p $log_path

    other_path="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman/newref_C204${i}_caveman_others"
    results_path="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman/newref_C204${i}_caveman_results"
    error_path="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman/newref_C204${i}_caveman_error"
    mkdir -p "$temp_path"
    mkdir -p "$other_path"
    mkdir -p "$results_path"
    mkdir -p "$error_path"

    config_file="$other_path/newref_C204${i}_caveman.cfg.ini"
    split_file="$other_path/splitList"
    alg_bean_file="$other_path/alg_bean"
    covs_arr="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman/newref_C204${i}_caveman_others/newref_C204${i}_caveman.covs_arr"
    probs_arr="/mnt/beegfs/scratch/MCFONSECA/pedro.silvestre/brca_project/temp/newref_C204${i}_caveman/newref_C204${i}_caveman_others/newref_C204${i}_caveman.probs_arr"
